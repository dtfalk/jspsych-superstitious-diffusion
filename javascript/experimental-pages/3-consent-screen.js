...
const consent_description_prolific = `
<div class="consent-text">
  ...
  <p><strong>Incentives:</strong> You will be compensated {prolific_compensation} for your participation in this study. You will also be entered into a raffle for a 50 dollar Amazon gift card. Your performance on the study will influence your chances of winning the raffle. The better you do, the higher your chances are to win the giftcard.</p>

  <p><strong>Risks and Benefits:</strong> Your participation in this study does not involve any risk to you beyond that of everyday life.
...
const consent_description_sona = `
<div class="consent-text">
  <p><strong>Study Number:</strong> IRB24-1770<br>
  <strong>Study Title:</strong> Superstitious Perception<br>
  <strong>Researcher(s):</strong> Shannon Heald</p>
  ...
  <p><strong>Incentives:</strong> You will be compensated {number_of_credits} SONA credits for your participation in this study. You will also be entered into a raffle for a 50 dollar Amazon gift card. Your performance on the study will influence your chances of winning the raffle. The better you do, the higher your chances are to win the giftcard.</p>
...
const consent_description_other = `
<div class="consent-text">
  <p><strong>Study Number:</strong> IRB24-1770<br>
  <strong>Study Title:</strong> Superstitious Perception<br>
  <strong>Researcher(s):</strong> Shannon Heald</p>
  ...
  <p><strong>Incentives:</strong> You will be compensated {other_compensation} for your participation in this study. You will also be entered into a raffle for a 50 dollar Amazon gift card. Your performance on the study will influence your chances of winning the raffle. The better you do, the higher your chances are to win the giftcard.</p>
...
const consent_screen = {
  ...
  on_start: function() {
    ...
    // Inject consent prompt based on experimental source
    if (experimentSource == "Prolific") {consent_screen.questions[0].prompt = consent_description_prolific}
    else if (experimentSource == "Sona") {consent_screen.questions[0].prompt = consent_description_sona}
    else {consent_screen.questions[0].prompt = consent_description_other}
    
  },
  on_finish: function(data) {
    const end_timestamp = performance.now()
    
    // Grab subject's consent response
    const response = data.response ? Object.values(data.response)[0] : null
    const consented = response === 'I consent to participate in this study'
    
    // If subject consents then we store consent info (Do not save otherwise)
    if (consented) {
...
const nonconsent_screen = {
  timeline: [
    {
      ...
      stimulus: '<div style="max-width:40rem; margin:0 auto; text-align:center;"><h2>Non Consent Screen</h2><p>Thank you for considering our experiment. Please close this tab to exit the experiment.</p></div>',
      choices: [' '],
      on_finish: function() {
  ...
  conditional_function: function() {
    ...
    const response = last.response ? Object.values(last.response)[0] : null;
