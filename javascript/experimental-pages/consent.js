...
<div class="consent-text">
  ...
  <p><strong>Incentives:</strong> You will be compensated {number_of_sona_credits_or_prolific_whatevers_or_whatever} for your participation in this study. You will also be entered into a raffle for a 50 dollar Amazon gift card. Your performance on the study will influence your chances of winning the raffle. The better you do, the higher your chances are to win the giftcard.</p>
  ...
  timeline: [
    {
      ...
      stimulus: '<div style="max-width:40rem; margin:0 auto; text-align:center;"><h2>Thank you</h2><p>Thank you for considering our experiment. Please close this tab to exit the experiment.</p></div>',
      choices: [' '],
      on_finish: function() {
